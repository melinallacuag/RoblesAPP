...
import kotlinx.android.synthetic.main.fragment_puntos_factura.view.*
...
class PuntosFacturaFragment : DialogFragment() {
    ...
    override fun onCreateView(
        ...
        var rootView: View = inflater.inflate(R.layout.fragment_puntos_factura,container,false)

        rootView.btncerrar.setOnClickListener{
            dismiss()
        }

        rootView.btncancelarpuntosfacturacion.setOnClickListener{
            dismiss()
        }

        rootView.btnagregarpuntosfacturacion.setOnClickListener{

            Toast.makeText(context,"Agregar Puntos Factura", Toast.LENGTH_LONG).show()
            dismiss()
        }
        return rootView
    }
